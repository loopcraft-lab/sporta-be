export const SPORT_MESSAGE = {
  CREATE_SUCCESS: 'Tạo thể thao thành công',
  UPDATE_SUCCESS: 'Cập nhật thể thao thành công',
...
export const SPORT_PROFILE_MESSAGE = {
  ...
  UPDATE_SUCCESS: 'Cập nhật hồ sơ thể thao thành công',
